        ...
        <>
            ...
            <div className="flex justify-center pt-6 bg-black overflow-hidden">
                ...
                <div className={`${styles.body} w-1/2 text-xl`}>
                    <div>
                        I like building things—whether it’s AI, firmware, or system architectures. I enjoy keeping myself busy with work that challenges me to think and problem-solve. 
